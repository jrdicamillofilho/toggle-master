...
Basta copiar cada seção para o respectivo serviço na pasta correta e preencher corretamente as AWS keys e intenal SERVICE_API_KEY baseando-se no README.md de cada microservice.
